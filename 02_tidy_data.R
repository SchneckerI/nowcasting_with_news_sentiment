...
news_sentiment_raw <- as.data.table(
  read_excel(paste0(data_path,"news_sentiment_data.xlsx"),
                                  sheet = "Data")
)
...
pmi_raw <- as.data.table(
  read_excel(paste0(data_path,"pmi.xlsx"), 
...
# save daily pmi data
write.csv(pmi_daily, file = paste0(data_path,"pmi_daily.csv"),
          row.names = FALSE)
...
# save daily pmi data
write.csv(daily_data, file = paste0(data_path,"daily_data.csv"),
          row.names = FALSE)
