...
# save
write.csv(gdp_gr, "C:/Users/yanni/OneDrive - Wirtschaftsuniversität Wien/Macrometrics/Project/data/gdp_latest_vintage.csv",
          row.names = FALSE)
...
save(real_time_gdp, file = "C:/Users/yanni/OneDrive - Wirtschaftsuniversität Wien/Macrometrics/Project/data/real_time_gdp.RData")
